\cite[Svorenova2017] introduce a procedure to solve the verification and synthesis problems for the class of discrete-time, continuous-space and -control, linear stochastic systems and specifications from the General Reactivity(1) fragment of linear temporal logic which have to be satisfied with probability 1, i.e.\ almost-surely.
...
Their refinement heuristics is able to generate a (partial) solution for the problem but the method proves to be computationally demanding.
...
The development of refinement techniques is supported by the implementation of an interactive visualization of the abstraction-analysis-refinement procedure.
This visualization is used as a platform for the design of refinement heuristics and can serve as an educational tool after this work has concluded.
