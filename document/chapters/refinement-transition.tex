As seen in previous section, there is a systematic way to decompose the game graph into a series of co-safe reachability problems based on the transitions of the automaton.
Combine with refinement based on robust operators from section \in[sec:refinement-robust] for which progress can be determined without the need for an expensive full analysis.
...
\startsubsection[title={Robust Reachability Refinement}]
...
\startsubsection[title={Layered Robust Reachability Refinement}]
