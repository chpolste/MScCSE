...
\startreusableMPgraphic{cases-corridor-backandforth-automaton-pruned}
    beginfig(0);
        with spacing((17,15)) matrix.a(9,9);
        node_double.a[1][1](btex $q_0$ etex);
        node_dash.a[1][8](btex $q_1$ etex);
...
\startsubsection[title={2-Recurrence and Safety}]
    ...
    \placefigure[top][fig:cases-corridor-backandforth-automaton]{
        ...
        \startcombination[nx=2,ny=1,distance=10mm]
            {\reuseMPgraphic{cases-corridor-backandforth-automaton}}{}
            {\reuseMPgraphic{cases-corridor-backandforth-automaton-pruned}}{}
        \stopcombination
    }
