...
\startsubsection[title={Robust Reachability Refinement},reference=sec:refinement-transition-reachability]
    ...
    Easy to see that refinement without post-processing (a) can quickly lead to state space explosion as jaggedness increases with every iteration and moves to smaller scales.
