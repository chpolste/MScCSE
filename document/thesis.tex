...
\starttext
    ...
    \startbodymatter
        ...
        \startchapter[title={Abstraction Refinement}]
            ...
            \startsection[title={Guidance},reference=sec:refinement-guidance]
            ...
            \startsection[title={Neutral Refinement},reference=sec:refinement-neutral]
                \input{chapters/refinement-neutral}
            \stopsection
