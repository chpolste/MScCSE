This work has been concerned with the computation of the set of initial states of a linear stochastic system, such there exists a control strategy to ensure an objective specified in the extended GR(1) fragment of linear temporal logic with probability 1.
...
Building on the ideas laid out by \cite[Svorenova2017], new refinement procedures were presented in this work.
