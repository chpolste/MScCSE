...
\starttext
    ...
    \startbodymatter
        ...
        \startchapter[title={Abstraction Refinement}]
            ...
            \startsection[title={Refinement with Robust Operators},reference=sec:refinement-robust]
                \input{chapters/refinement-robust}
            \stopsection

            \startsection[title={Product Refinement},reference=sec:refinement-product]
                \input{chapters/refinement-product}
            \stopsection

            \startsection[title={Reduction Approaches},reference=sec:refinement-reduction]
        ...
        \startchapter[title={An Interactive Implementation}]
            ...
            \startsection[title={Platform Selection}]
                \input{chapters/implementation-platform}
            \stopsection

            \startsection[title={Features}]
