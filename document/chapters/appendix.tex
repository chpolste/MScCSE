...
\startsubject[title={State Widgets}]
    ...
    These widgets are found in the \quotation{State} tab of the sidebar, shown in \in{Figure}[fig:appendix-widgets-one], left.
...
\placefigure[top][fig:appendix-widgets-one]{
    The \quotation{State} and \quotation{System} tabs of the sidebar of the interactive implementation (see \in{Figure}[fig:implementation-features-inspector]).
}{
    \startcombination[2*1]
        {\externalfigure[appendix-tab-state][width=0.45\textwidth]}{}
        {\externalfigure[appendix-tab-system][width=0.45\textwidth]}{}
    \stopcombination
}
...
\placefigure[top][fig:appendix-widgets-two]{
    The \quotation{Control} and \quotation{Info} tabs of the sidebar of the interactive implementation (see \in{Figure}[fig:implementation-features-inspector]).
}{
    \startcombination[2*1]
        {\externalfigure[appendix-tab-control][width=0.45\textwidth]}{}
        {\externalfigure[appendix-tab-info][width=0.45\textwidth]}{}
    \stopcombination
}
...
\startsubject[title=Info Widgets]
    ...
    These widgets are found in the \quotation{Info} tab of the sidebar, shown in \in{Figure}[fig:appendix-widgets-two], right.
