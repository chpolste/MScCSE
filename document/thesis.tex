...
\starttext
    ...
    \startbodymatter
        ...
        \startchapter[title={Abstraction Refinement}]
            ...
            \startsection[title={Refinement Conditions},reference=sec:refinement-conditions]
                \input{chapters/refinement-conditions}
            \stopsection
            ...
            \startsection[title={Coordinating Refinement},reference=sec:refinement-coordination]
