...
\starttext
    ...
    \startbodymatter
        ...
        \startchapter[title={Theoretical Foundations}]
            ...
            \startsection[title={Finite Automata}]
            ...
            \startsection[title={Markov Decision Processes and Probabilistic Games}]
            ...
            \startsection[title={Abstraction and Refinement}]
                %\input{chapters/theory-abstraction}
            \stopsection
