...
The co-safe interpretation of The objective is chosen and the automaton from \in{Table}[tab:theory-logic-objectives] used.
...
\startsubsection[title={Neutral Refinement},reference=sec:cases-integrator-neutral]
    ...
    After the negative refinement from (\in{Table}[tab:cases-integrator-negative]), safety refinement is applied twice, followed by 5 iterations of self-loop removal without intermediate analysis.
