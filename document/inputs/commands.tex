...
\define[1]\NoStates{X_{\mathrm no}^{#1}}
\define[1]\YesStates{X_{\mathrm yes}^{#1}}
\define[1]\MaybeStates{X_{\mathrm ?}^{#1}}
...
\definemathcommand[RefinePos][nolop]{\mfunction{Refine_+}}
...
\definemathcommand[Until][op]{{\mathss U}}
...
\define[1]\AlmostCoop{\AlmostSure_{#1}^{\Cooperative}}
