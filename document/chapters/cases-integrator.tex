...
\startsubsection[title={Positive Robust Refinement},reference=sec:cases-integrator-positive]
    ...
    The two-step refinement is applied again in \in{Table}[tab:cases-integrator-positive-suppressed] with two modifications:
    ...
    Note that this does not prevent the creation of such states entirely as the small state suppression is only applied to the $\AttrR$-region.
