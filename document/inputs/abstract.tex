...
A holistic refinement procedures are proposed that match problematic patterns in the abstraction and break them by refining the state space partition with respect to one step of the system dynamics.
...
Results show that that the robust framework is able to significantly reduce the size of the state space partition compared to previous methods, thereby improving the performance of the verification procedure.
Its multi-step nature is able to make progress also for rich specifications.
