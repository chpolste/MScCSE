...
Such jaggedness quickly snowballs into an explosion of the number of partition elements (see also Figure \in[fig:refinement-transition-jagged]a, where this is demonstrated for continuous dynamics), which can offset the complexity reduction gained from the MDP abstraction.
